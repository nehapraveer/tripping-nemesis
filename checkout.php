...
?>
<form method="POST" action="?q=orderconfirm">
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 well">
        ...
        <form>
          <div class="order row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 order-input">
                <input name="billaddress" class="form-control" placeholder="Address" tabindex="1" type="text"
                       value="<?php echo $cust->getAddress(); ?>">
            </div>
            <div class="col-xs-5 col-sm-5 col-md-5 order-input">
                <input name="billcity" class="form-control" placeholder="City" tabindex="1" type="text"
                       value="<?php echo $cust->getCity(); ?>">
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 order-input">
                <input name="billstate" class="form-control" placeholder="State" tabindex="1" type="text"
                       value="<?php echo $cust->getState(); ?>">
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 order-input">
                <input name="billzip" class="form-control" placeholder="Zip" tabindex="1" type="text"
            ...
            <div class="col-xs-12 col-md-12">
              <input value="Place Order" name="placeorder" class="btn btn-primary btn-block btn-lg" tabindex="7" type="submit">
            </div>
          </div>
        </form>
      </div>
